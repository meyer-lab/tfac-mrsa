...
def fig_3_setup():
    ...
    T_mem_active = (deconv["T cell CD4+ memory activated"].values - deconv["T cell CD4+ memory activated"].mean()) / deconv[
    ...
    T_mem_resting = (deconv["T cell CD4+ memory resting"].values - deconv["T cell CD4+ memory resting"].mean()) / deconv[
